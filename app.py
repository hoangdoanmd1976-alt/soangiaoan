...
<div class="main-header">
  ...
  <P> Tácgiả: Hoàng Thị Đoàn- Trường Tiểu học Minh Dân - ĐT: 0334158921</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025  - Hoàng Thị Đoàn - Trường Trường Tiểu học Minh Dân - ĐT: 0334158921 </div>", unsafe_allow_html=True)
